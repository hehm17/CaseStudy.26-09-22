...
public class StaffMain {
	...
	public static void main(String[] args) {
		...
		applicantList.forEach((s)->System.out.println(s));

		System.out.println("Output format");
		System.out.println("\nSummary : ");
        String output=String.format("\n%-5s %-10s %-10s %-10s %-10S %-10S |","name","marks1","marks2","marks3","TOTAL","PERCENTAGE");
        System.out.println(output);
        applicantList.forEach(x->System.out.println(x)); 
        }
